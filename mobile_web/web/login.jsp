...
<%--    <link rel="stylesheet" href="FinalLab/TrangChu/bootstrap-4.3.1-dist/css2/css/main.css">--%>
...
<%--    <link rel="stylesheet" href="FinalLab/TrangChu/bootstrap-4.3.1-dist/css2/css/dangky.css">--%>
<%--    <script src="js/tet.js"></script>--%>
<%--</head>--%>
<%--<body>--%>
<%--    <%@include file="HeaderTest.jsp"%>--%>
<%--    <div id="form-dangky">--%>
<%--&lt;%&ndash;        <div class="contain" style=" background: url(http://localhost:63342/Demo/web/FinalLab/TrangChu/img/bg_top.png) no-repeat top center , url(http://localhost:63342/Demo/web/FinalLab/TrangChu/img/bg_bot.png) no-repeat bottom center #fbf6e3">&ndash;%&gt;--%>
...
<%--                                </div>--%>
<%--&lt;%&ndash;                                &lt;%&ndash;%>--%>
<%--&lt;%&ndash;                                    if(session.getAttribute("errDNU")!= null)&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    {&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        Err err = (Err) session.getAttribute("errDNU");&ndash;%&gt;--%>
<%--&lt;%&ndash;    //                                String[] errMang = err.getLoi().toArray(new String[0]);&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        for(String errCon:err.getLoi())&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        {&ndash;%&gt;--%>
<%--&lt;%&ndash;                                %>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <p style="width: 256px;color: red;margin-left: 50px;">  <%=errCon%></p>&ndash;%&gt;--%>
